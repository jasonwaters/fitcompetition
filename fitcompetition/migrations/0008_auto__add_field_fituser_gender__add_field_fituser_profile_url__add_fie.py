...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FitUser.gender'
        db.add_column(u'fitcompetition_fituser', 'gender',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FitUser.profile_url'
        db.add_column(u'fitcompetition_fituser', 'profile_url',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FitUser.medium_picture'
        db.add_column(u'fitcompetition_fituser', 'medium_picture',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FitUser.normal_picture'
        db.add_column(u'fitcompetition_fituser', 'normal_picture',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FitUser.gender'
        db.delete_column(u'fitcompetition_fituser', 'gender')

        # Deleting field 'FitUser.profile_url'
        db.delete_column(u'fitcompetition_fituser', 'profile_url')

        # Deleting field 'FitUser.medium_picture'
        db.delete_column(u'fitcompetition_fituser', 'medium_picture')

        # Deleting field 'FitUser.normal_picture'
        db.delete_column(u'fitcompetition_fituser', 'normal_picture')
