...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FitUser.mapmyfitnessToken'
        db.add_column(u'fitcompetition_fituser', 'mapmyfitnessToken',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FitUser.mapmyfitnessTokenSecret'
        db.add_column(u'fitcompetition_fituser', 'mapmyfitnessTokenSecret',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FitUser.mapmyfitnessToken'
        db.delete_column(u'fitcompetition_fituser', 'mapmyfitnessToken')

        # Deleting field 'FitUser.mapmyfitnessTokenSecret'
        db.delete_column(u'fitcompetition_fituser', 'mapmyfitnessTokenSecret')
