...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Transaction.transactionID'
        db.delete_column(u'fitcompetition_transaction', 'transactionID')

        # Adding field 'Transaction.stripeID'
        db.add_column(u'fitcompetition_transaction', 'stripeID',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Transaction.transactionID'
        db.add_column(u'fitcompetition_transaction', 'transactionID',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Transaction.stripeID'
        db.delete_column(u'fitcompetition_transaction', 'stripeID')
