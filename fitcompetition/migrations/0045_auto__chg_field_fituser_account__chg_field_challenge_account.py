...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FitUser.account'
        db.alter_column(u'fitcompetition_fituser', 'account_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fitcompetition.Account'], null=True))

        # Changing field 'Challenge.account'
        db.alter_column(u'fitcompetition_challenge', 'account_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fitcompetition.Account'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FitUser.account'
        raise RuntimeError("Cannot reverse this migration. 'FitUser.account' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'FitUser.account'
        db.alter_column(u'fitcompetition_fituser', 'account_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fitcompetition.Account']))

        # User chose to not deal with backwards NULL issues for 'Challenge.account'
        raise RuntimeError("Cannot reverse this migration. 'Challenge.account' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Challenge.account'
        db.alter_column(u'fitcompetition_challenge', 'account_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fitcompetition.Account']))
