...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FitnessActivity.hasEvidence'
        db.add_column(u'fitcompetition_fitnessactivity', 'hasEvidence',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FitnessActivity.hasEvidence'
        db.delete_column(u'fitcompetition_fitnessactivity', 'hasEvidence')
