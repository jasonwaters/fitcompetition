...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'fitcompetition_fituser', 'lastHealthGraphUpdate', 'lastExternalSyncDate')

    def backwards(self, orm):
        db.rename_column(u'fitcompetition_fituser', 'lastExternalSyncDate', 'lastHealthGraphUpdate')
