...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Challenge.reconciled'
        db.add_column(u'fitcompetition_challenge', 'reconciled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.reconciled'
        db.delete_column(u'fitcompetition_challenge', 'reconciled')
