...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field players on 'Challenge'
        m2m_table_name = db.shorten_name(u'fitcompetition_challenge_players')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('challenge', models.ForeignKey(orm[u'fitcompetition.challenge'], null=False)),
            ('fituser', models.ForeignKey(orm[u'fitcompetition.fituser'], null=False))
        ))
        db.create_unique(m2m_table_name, ['challenge_id', 'fituser_id'])


    def backwards(self, orm):
        # Removing M2M table for field players on 'Challenge'
        db.delete_table(db.shorten_name(u'fitcompetition_challenge_players'))
    ...
    models = {
        ...
        u'fitcompetition.challenge': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'players': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['fitcompetition.FitUser']", 'symmetrical': 'False'}),
