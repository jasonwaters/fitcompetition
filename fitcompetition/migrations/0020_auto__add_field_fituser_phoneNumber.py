...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'FitUser.phoneNumber'
        db.add_column(u'fitcompetition_fituser', 'phoneNumber',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)

        if not db.dry_run:
            orm.FitUser.objects.exclude(username='admin').update(email='')

    def backwards(self, orm):
        # Deleting field 'FitUser.phoneNumber'
        db.delete_column(u'fitcompetition_fituser', 'phoneNumber')
