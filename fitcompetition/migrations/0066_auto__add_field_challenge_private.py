...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Challenge.private'
        db.add_column(u'fitcompetition_challenge', 'private',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.private'
        db.delete_column(u'fitcompetition_challenge', 'private')
