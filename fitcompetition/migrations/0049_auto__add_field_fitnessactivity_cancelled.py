...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FitnessActivity.cancelled'
        db.add_column(u'fitcompetition_fitnessactivity', 'cancelled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FitnessActivity.cancelled'
        db.delete_column(u'fitcompetition_fitnessactivity', 'cancelled')
