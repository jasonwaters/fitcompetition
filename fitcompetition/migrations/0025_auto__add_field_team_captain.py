...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'fitcompetition_team', 'captain',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='captain', null=True, blank=True, to=orm['fitcompetition.FitUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Team.captain'
        db.delete_column(u'fitcompetition_team', 'captain_id')
