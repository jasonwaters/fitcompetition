...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'fitcompetition_account', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['fitcompetition.FitUser'], null=True, blank=True)),
            ('challenge', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['fitcompetition.Challenge'], null=True, blank=True)),
        ))
        db.send_create_signal(u'fitcompetition', ['Account'])

        # Adding field 'Transaction.account'
        db.add_column(u'fitcompetition_transaction', 'account',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'fitcompetition_account')

        # Deleting field 'Transaction.account'
        db.delete_column(u'fitcompetition_transaction', 'account_id')
