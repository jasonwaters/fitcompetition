...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'fitcompetition_challenge', 'type',
                      self.gf('django.db.models.fields.CharField')(default='SIMP', max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.type'
        db.delete_column(u'fitcompetition_challenge', 'type')
