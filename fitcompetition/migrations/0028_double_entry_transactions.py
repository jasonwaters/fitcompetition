...
class Migration(SchemaMigration):
    def forwards(self, orm):
        if not db.dry_run:
            transactions = orm.Transaction.objects.filter(account_id=0,
                                                          user__isnull=False,
                                                          challenge__isnull=True)

            for transaction in transactions:
                account = orm.Account.objects.get(user=transaction.user)
            ...
            for transaction in transactions:
                userAccount = orm.Account.objects.get(user=transaction.user)
                challengeAccount = orm.Account.objects.get(challenge=transaction.challenge)

                transaction.account = userAccount

                desc = ""
                if "Joined" in transaction.description:
                    desc = "%s Joined" % transaction.user.fullname
                elif "Winnings" in transaction.description:
                    desc = "Disbursement to %s" % transaction.user.fullname
                    transaction.description = 'Disbursement for "%s"' % transaction.challenge.name
                elif "Withdrew from" in transaction.description:
                    desc = "%s Withdrew" % transaction.user.fullname

                transaction.save()

                orm.Transaction.objects.create(account=challengeAccount,
    ...
    models = {
        ...
        u'fitcompetition.account': {
            ...
            'challenge': ('django.db.models.fields.related.ForeignKey', [],
                          {'default': 'None', 'to': u"orm['fitcompetition.Challenge']", 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [],
                     {'default': 'None', 'to': u"orm['fitcompetition.FitUser']", 'null': 'True', 'blank': 'True'})
        },
        ...
        u'fitcompetition.challenge': {
            ...
            'approvedActivities': (
                'django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['fitcompetition.ActivityType']", 'symmetrical': 'False'}),
            ...
            'players': ('django.db.models.fields.related.ManyToManyField', [],
                        {'default': 'None', 'to': u"orm['fitcompetition.FitUser']", 'through': u"orm['fitcompetition.Challenger']", 'blank': 'True',
                         'symmetrical': 'False', 'null': 'True'}),
            'startdate': ('django.db.models.fields.DateTimeField', [], {}),
            'type': ('django.db.models.fields.CharField', [], {'default': "'SIMP'", 'max_length': '6'})
        },
        ...
        u'fitcompetition.team': {
            ...
            'captain': ('django.db.models.fields.related.ForeignKey', [],
                        {'default': 'None', 'related_name': "'captain'", 'null': 'True', 'blank': 'True', 'to': u"orm['fitcompetition.FitUser']"}),
            'challenge': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fitcompetition.Challenge']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'members': ('django.db.models.fields.related.ManyToManyField', [],
                        {'related_name': "'members'", 'default': 'None', 'to': u"orm['fitcompetition.FitUser']", 'blank': 'True',
                         'symmetrical': 'False', 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'})
        },
