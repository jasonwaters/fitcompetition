...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Challenge.disbursementAmount'
        db.add_column(u'fitcompetition_challenge', 'disbursementAmount',
                      self.gf('fitcompetition.models.CurrencyField')(default=0, null=True, max_digits=16, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Challenge.numWinners'
        db.add_column(u'fitcompetition_challenge', 'numWinners',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.disbursementAmount'
        db.delete_column(u'fitcompetition_challenge', 'disbursementAmount')

        # Deleting field 'Challenge.numWinners'
        db.delete_column(u'fitcompetition_challenge', 'numWinners')
