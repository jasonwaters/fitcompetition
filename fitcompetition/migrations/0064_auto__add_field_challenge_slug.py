...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Challenge.slug'
        db.add_column(u'fitcompetition_challenge', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=None, max_length=150),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.slug'
        db.delete_column(u'fitcompetition_challenge', 'slug')
