...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'fitcompetition_transaction', 'balance',
                      self.gf('fitcompetition.models.CurrencyField')(default=None, null=True, max_digits=16, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.balance'
        db.delete_column(u'fitcompetition_transaction', 'balance')
