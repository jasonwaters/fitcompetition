...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FitnessActivity.hasProof'
        db.add_column(u'fitcompetition_fitnessactivity', 'hasProof',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FitnessActivity.hasProof'
        db.delete_column(u'fitcompetition_fitnessactivity', 'hasProof')
