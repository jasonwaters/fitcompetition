...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FitUser.integrationName'
        db.add_column(u'fitcompetition_fituser', 'integrationName',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FitUser.integrationName'
        db.delete_column(u'fitcompetition_fituser', 'integrationName')
