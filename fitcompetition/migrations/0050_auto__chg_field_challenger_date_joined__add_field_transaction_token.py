...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Challenger.date_joined'
        db.alter_column('fitcompetition_challenge_players', 'date_joined', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
        # Adding field 'Transaction.token'
        db.add_column(u'fitcompetition_transaction', 'token',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Challenger.date_joined'
        db.alter_column('fitcompetition_challenge_players', 'date_joined', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Deleting field 'Transaction.token'
        db.delete_column(u'fitcompetition_transaction', 'token')
    ...
    models = {
        ...
        u'fitcompetition.transaction': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '255', 'null': 'True', 'blank': 'True'})
        }
    }
