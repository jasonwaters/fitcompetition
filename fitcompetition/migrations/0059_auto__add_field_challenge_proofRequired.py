...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Challenge.proofRequired'
        db.add_column(u'fitcompetition_challenge', 'proofRequired',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.proofRequired'
        db.delete_column(u'fitcompetition_challenge', 'proofRequired')
