...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'fitcompetition_transaction', 'date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Transaction.date'
        db.alter_column(u'fitcompetition_transaction', 'date', self.gf('django.db.models.fields.DateField')())
