...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'fitcompetition_transaction', 'user_id')

        # Deleting field 'Transaction.challenge'
        db.delete_column(u'fitcompetition_transaction', 'challenge_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Transaction.user'
        raise RuntimeError("Cannot reverse this migration. 'Transaction.user' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Transaction.user'
        db.add_column(u'fitcompetition_transaction', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fitcompetition.FitUser']),
                      keep_default=False)

        # Adding field 'Transaction.challenge'
        db.add_column(u'fitcompetition_transaction', 'challenge',
    ...
    models = {
        ...
        u'fitcompetition.account': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['fitcompetition.FitUser']", 'null': 'True', 'blank': 'True'})
        },
