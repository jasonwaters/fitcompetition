...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'fitcompetition_fitnessactivity', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fitcompetition.ActivityType'], null=True))

    def backwards(self, orm):

        # Changing field 'FitnessActivity.type'
        db.alter_column(u'fitcompetition_fitnessactivity', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['fitcompetition.ActivityType']))
