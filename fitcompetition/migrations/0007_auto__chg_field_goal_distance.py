...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Goal.distance'
        db.alter_column(u'fitcompetition_goal', 'distance', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Goal.distance'
        db.alter_column(u'fitcompetition_goal', 'distance', self.gf('django.db.models.fields.IntegerField')())
