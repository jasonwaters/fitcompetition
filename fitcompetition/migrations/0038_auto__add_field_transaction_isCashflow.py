...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.isCashflow'
        db.add_column(u'fitcompetition_transaction', 'isCashflow',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.isCashflow'
        db.delete_column(u'fitcompetition_transaction', 'isCashflow')
