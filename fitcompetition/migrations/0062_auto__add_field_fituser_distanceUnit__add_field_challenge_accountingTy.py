...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FitUser.distanceUnit'
        db.add_column(u'fitcompetition_fituser', 'distanceUnit',
                      self.gf('django.db.models.fields.CharField')(default='mi', max_length=6),
                      keep_default=False)

        # Adding field 'Challenge.accountingType'
        db.add_column(u'fitcompetition_challenge', 'accountingType',
                      self.gf('django.db.models.fields.CharField')(default='distance', max_length=20),
                      keep_default=False)

        # Adding field 'Challenge.calories'
        db.add_column(u'fitcompetition_challenge', 'calories',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=10),
                      keep_default=False)

        # Adding field 'Challenge.duration'
        db.add_column(u'fitcompetition_challenge', 'duration',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=10),
                      keep_default=False)


        # Changing field 'Challenge.distance'
        db.alter_column(u'fitcompetition_challenge', 'distance', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=10))

    def backwards(self, orm):
        # Deleting field 'FitUser.distanceUnit'
        db.delete_column(u'fitcompetition_fituser', 'distanceUnit')

        # Deleting field 'Challenge.accountingType'
        db.delete_column(u'fitcompetition_challenge', 'accountingType')

        # Deleting field 'Challenge.calories'
        db.delete_column(u'fitcompetition_challenge', 'calories')

        # Deleting field 'Challenge.duration'
        db.delete_column(u'fitcompetition_challenge', 'duration')


        # Changing field 'Challenge.distance'
        db.alter_column(u'fitcompetition_challenge', 'distance', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2))
    ...
    models = {
        ...
        u'fitcompetition.account': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'stripeCustomerID': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        ...
        u'fitcompetition.challenge': {
            ...
            'accountingType': ('django.db.models.fields.CharField', [], {'default': "'distance'", 'max_length': '20'}),
            ...
            'calories': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '20', 'decimal_places': '10'}),
            ...
            'distance': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '20', 'decimal_places': '10'}),
            'duration': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '20', 'decimal_places': '10'}),
            ...
            'proofRequired': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'fitcompetition.challenger': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'fitcompetition.fitnessactivity': {
            ...
            'hasProof': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'activities'", 'to': u"orm['fitcompetition.FitUser']"})
        },
        u'fitcompetition.fituser': {
            'Meta': {'ordering': "['fullname']", 'object_name': 'FitUser'},
            'account': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['fitcompetition.Account']", 'null': 'True', 'blank': 'True'}),
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'distanceUnit': ('django.db.models.fields.CharField', [], {'default': "'mi'", 'max_length': '6'}),
            ...
            'timezone': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        u'fitcompetition.team': {
            ...
            'challenge': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'teams'", 'to': u"orm['fitcompetition.Challenge']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'fitcompetition.transaction': {
            ...
            'stripeID': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '255', 'null': 'True', 'blank': 'True'})
        }
    }
