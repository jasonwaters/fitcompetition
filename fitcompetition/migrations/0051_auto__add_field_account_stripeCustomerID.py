...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.stripeCustomerID'
        db.add_column(u'fitcompetition_account', 'stripeCustomerID',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.stripeCustomerID'
        db.delete_column(u'fitcompetition_account', 'stripeCustomerID')
