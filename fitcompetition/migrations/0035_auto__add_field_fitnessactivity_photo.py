...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FitnessActivity.photo'
        db.add_column(u'fitcompetition_fitnessactivity', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FitnessActivity.photo'
        db.delete_column(u'fitcompetition_fitnessactivity', 'photo')
