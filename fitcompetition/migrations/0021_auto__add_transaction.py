...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'fitcompetition_transaction', (
            ...
            ('amount', self.gf('fitcompetition.models.CurrencyField')(max_digits=16, decimal_places=2)),
        ...
        db.send_create_signal(u'fitcompetition', ['Transaction'])


    def backwards(self, orm):
        # Deleting model 'Transaction'
        db.delete_table(u'fitcompetition_transaction')
