...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Challenge.middate'
        db.add_column(u'fitcompetition_challenge', 'middate',
        ...
        if not db.dry_run:
            ...
            for challenge in challenges:
                challenge.middate = challenge.startdate + ((challenge.enddate-challenge.startdate)/2)
                challenge.save()

    def backwards(self, orm):
        # Deleting field 'Challenge.middate'
        db.delete_column(u'fitcompetition_challenge', 'middate')
    ...
    models = {
        ...
        u'fitcompetition.challenge': {
            ...
            'disbursementAmount': (
                'fitcompetition.models.CurrencyField', [], {'default': '0', 'null': 'True', 'max_digits': '16', 'decimal_places': '2', 'blank': 'True'}),
