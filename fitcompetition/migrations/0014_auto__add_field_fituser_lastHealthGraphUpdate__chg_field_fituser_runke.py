...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FitUser.lastHealthGraphUpdate'
        db.add_column(u'fitcompetition_fituser', 'lastHealthGraphUpdate',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


        # Changing field 'FitUser.runkeeperToken'
        db.alter_column(u'fitcompetition_fituser', 'runkeeperToken', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'FitUser.fullname'
        db.alter_column(u'fitcompetition_fituser', 'fullname', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting field 'FitUser.lastHealthGraphUpdate'
        db.delete_column(u'fitcompetition_fituser', 'lastHealthGraphUpdate')


        # Changing field 'FitUser.runkeeperToken'
        db.alter_column(u'fitcompetition_fituser', 'runkeeperToken', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'FitUser.fullname'
        db.alter_column(u'fitcompetition_fituser', 'fullname', self.gf('django.db.models.fields.CharField')(default=None, max_length=255))
