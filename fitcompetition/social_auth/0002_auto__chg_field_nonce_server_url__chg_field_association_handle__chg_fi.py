...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'social_auth_nonce', 'server_url', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Association.handle'
        db.alter_column(u'social_auth_association', 'handle', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Association.server_url'
        db.alter_column(u'social_auth_association', 'server_url', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Nonce.server_url'
        db.alter_column(u'social_auth_nonce', 'server_url', self.gf('django.db.models.fields.CharField')(max_length=100))
